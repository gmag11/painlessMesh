// Adaption of the TaskScheduler library, which supports std::function
...
class Task {
    ...
    public:
		inline Task(unsigned long aInterval=0, long aIterations=0, 
                callback_t aCallback = [](){}, Scheduler* aScheduler=NULL, bool aEnable=false, bool (*aOnEnable)()=NULL, void (*aOnDisable)()=NULL);
#ifdef _TASK_STATUS_REQUEST
		inline Task(callback_t aCallback = [](){}, Scheduler* aScheduler=NULL, bool (*aOnEnable)()=NULL, void (*aOnDisable)()=NULL);
#endif  // _TASK_STATUS_REQUEST
		...
		inline void set(unsigned long aInterval, long aIterations, callback_t aCallback = [](){},bool (*aOnEnable)()=NULL, void (*aOnDisable)()=NULL);
 ...
 */
Task::Task( unsigned long aInterval, long aIterations, callback_t aCallback, Scheduler* aScheduler, bool aEnable, bool (*aOnEnable)(), void (*aOnDisable)() ) {
	reset();
 ...
 */
void Task::set(unsigned long aInterval, long aIterations, callback_t aCallback, bool (*aOnEnable)(), void (*aOnDisable)()) {
	setInterval(aInterval); 
